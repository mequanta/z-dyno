def get_pricing(symbols, start_date='2013-01-03', end_date='2014-01-03', symbol_reference_date=None, frequency='daily', fields=None, handle_missing='raise'):
    pass
...
class AlgorithmResult:
    def __init__(result_iterator, progress_bar, algo_id):
        pass

    def create_full_tear_sheet(benchmark_rets=None, live_start_date=None, bayesian=False, cone_std=1.0):
        pass
